...
! RUN:   %lfort -target i386-apple-darwin9 -DTEST0 -E %s
#ifdef TEST0
...
! RUN:   %lfort -target i386-apple-darwin9 -DTEST1 -E %s
#ifdef TEST1
...
! RUN:   %lfort -target i386-apple-darwin9 -DTEST2 -E %s
#ifdef TEST2
...
! RUN:   %lfort -target i386-apple-darwin9 -DTEST3 -E %s
#ifdef TEST3
