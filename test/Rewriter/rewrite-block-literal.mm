// RUN: %lfort_cc1 -E %s -o %t.mm
// RUN: %lfort_cc1 -x objective-c++ -fblocks -fms-extensions -rewrite-objc %t.mm -o - | FileCheck %s
...
// RUN: %lfort_cc1 -x objective-c++ -Wno-return-type -fblocks -fms-extensions -rewrite-objc %s -o %t-modern-rw.cpp
