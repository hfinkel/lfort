//===- NeonEmitter.cpp - Generate arm_neon.h for use with lfort -*- C++ -*-===//
//
...
/// BuiltinTypeString - for a modifier and type, generate the lfort
/// BuiltinsARM.def prototype code for the function.  See the top of lfort's
