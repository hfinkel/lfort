// RUN: %lfort_cc1 -Wstrncat-size -verify -fsyntax-only %s
// RUN: %lfort_cc1 -DUSE_BUILTINS -Wstrncat-size -verify -fsyntax-only %s
// RUN: %lfort_cc1 -fsyntax-only -Wstrncat-size -fixit -x c %s
// RUN: %lfort_cc1 -DUSE_BUILTINS -fsyntax-only -Wstrncat-size -fixit -x c %s
