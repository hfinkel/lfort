// RUN: not %lfort_cc1 -fmessage-length 72 %s 2>&1 | FileCheck -strict-whitespace %s
// RUN: not %lfort_cc1 -fmessage-length 1 %s
// RUN: not %lfort_cc1 -fmessage-length 8 %s 2>&1 | FileCheck -check-prefix=CHECK-DOT %s
