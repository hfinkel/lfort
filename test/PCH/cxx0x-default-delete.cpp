// Without PCH
// RUN: %lfort_cc1 -std=c++11 -fsyntax-only -verify -include %s %s
// With PCH
// RUN: %lfort_cc1 -x c++-header -std=c++11 -emit-pch -o %t %s
// RUN: %lfort_cc1 -std=c++11 -fsyntax-only -verify -include-pch %t %s
