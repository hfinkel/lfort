// RUN: %lfort_cc1 -std=c++11 -fsyntax-only -verify %s -DMAX=128 -fconstexpr-depth 128
// RUN: %lfort_cc1 -std=c++11 -fsyntax-only -verify %s -DMAX=2 -fconstexpr-depth 2
// RUN: %lfort -std=c++11 -fsyntax-only -Xlfort -verify %s -DMAX=10 -fconstexpr-depth=10
