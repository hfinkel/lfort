// RUN: %lfort_cc1 -w -fdump-record-layouts %s 2> %t.layouts
// RUN: %lfort_cc1 -w -fdump-record-layouts-simple %s > %t.before 2>&1
// RUN: %lfort_cc1 -w -DPACKED= -DALIGNED16= -fdump-record-layouts-simple -foverride-record-layout=%t.layouts %s > %t.after 2>&1
