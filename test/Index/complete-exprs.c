...
// RUN: c-index-test -code-completion-at=%s:7:9 -Xlfort -code-completion-patterns %s | FileCheck -check-prefix=CHECK-CC1 %s
// RUN: env CINDEXTEST_EDITING=1 CINDEXTEST_COMPLETION_CACHING=1 c-index-test -code-completion-at=%s:7:9 -Xlfort -code-completion-patterns %s | FileCheck -check-prefix=CHECK-CC1 %s
...
// RUN: env CINDEXTEST_EDITING=1 CINDEXTEST_COMPLETION_CACHING=1 c-index-test -code-completion-at=%s:7:9 -Xlfort -code-completion-patterns %s | FileCheck -check-prefix=CHECK-CC1 %s
// RUN: c-index-test -code-completion-at=%s:7:14 -Xlfort -code-completion-patterns %s | FileCheck -check-prefix=CHECK-CC3 %s
// RUN: env CINDEXTEST_EDITING=1 CINDEXTEST_COMPLETION_CACHING=1 c-index-test -code-completion-at=%s:7:14 -Xlfort -code-completion-patterns %s | FileCheck -check-prefix=CHECK-CC3 %s
...
// RUN: c-index-test -code-completion-at=%s:7:18 -Xlfort -code-completion-patterns %s | FileCheck -check-prefix=CHECK-CC3 %s
// RUN: c-index-test -code-completion-at=%s:7:22 -Xlfort -code-completion-patterns %s | FileCheck -check-prefix=CHECK-CC3 %s
// RUN: c-index-test -code-completion-at=%s:7:2 -Xlfort -code-completion-patterns %s | FileCheck -check-prefix=CHECK-CC2 %s
...
// RUN: c-index-test -code-completion-at=%s:11:16 -Xlfort -code-completion-patterns %s | FileCheck -check-prefix=CHECK-CC4 %s
...
// RUN: c-index-test -code-completion-at=%s:19:3 -Xlfort -code-completion-patterns %s | FileCheck -check-prefix=CHECK-CC6 %s
...
// RUN: c-index-test -code-completion-at=%s:24:4 -Xlfort -code-completion-patterns %s | FileCheck -check-prefix=CHECK-CC7 %s
// RUN: env CINDEXTEST_EDITING=1 CINDEXTEST_COMPLETION_CACHING=1 c-index-test -code-completion-at=%s:24:4 -Xlfort -code-completion-patterns %s | FileCheck -check-prefix=CHECK-CC7 %s
