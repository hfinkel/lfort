// RUN: %lfort_cc1 -emit-pch -x objective-c++ -std=c++0x -o %t %s
// RUN: %lfort_cc1 -include-pch %t -x objective-c++ -std=c++0x  -verify %s
// RUN: %lfort_cc1 -include-pch %t -x objective-c++ -std=c++0x  -ast-print %s | FileCheck -check-prefix=PRINT %s
// RUN: %lfort_cc1 -include-pch %t -x objective-c++ -std=c++0x  -emit-llvm -o - %s | FileCheck -check-prefix=IR %s
