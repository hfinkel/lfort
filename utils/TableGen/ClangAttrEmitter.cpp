//===- LFortAttrEmitter.cpp - Generate LFort attribute handling =-*- C++ -*--=//
//
...
//===----------------------------------------------------------------------===//
//
// These tablegen backends emit LFort attribute processing code
//
//===----------------------------------------------------------------------===//
...
void EmitLFortAttrClass(RecordKeeper &Records, raw_ostream &OS) {
  ...
  OS << "#ifndef LLVM_LFORT_ATTR_CLASSES_INC\n";
  OS << "#define LLVM_LFORT_ATTR_CLASSES_INC\n\n";
