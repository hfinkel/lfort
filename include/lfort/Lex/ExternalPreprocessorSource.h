...
//
//===----------------------------------------------------------------------===//
#ifndef LLVM_LFORT_LEX_EXTERNAL_PREPROCESSOR_SOURCE_H
#define LLVM_LFORT_LEX_EXTERNAL_PREPROCESSOR_SOURCE_H
...
#endif // LLVM_LFORT_LEX_EXTERNAL_PREPROCESSOR_SOURCE_H
