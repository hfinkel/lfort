// RUN: %lfort_cc1 -triple i686-linux-gnu -emit-llvm %s -O0 -o - | FileCheck %s --check-prefix=CHECK-O0
// RUN: %lfort_cc1 -triple i686-linux-gnu -emit-llvm %s -O1 -o - | FileCheck %s
