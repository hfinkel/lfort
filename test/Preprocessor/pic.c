...
// CHECK-NOT: #define __pie__
//
// RUN: %lfort_cc1 -pic-level 1 -dM -E -o - %s \
...
// CHECK-PIC1-NOT: #define __pie__
//
// RUN: %lfort_cc1 -pic-level 2 -dM -E -o - %s \
...
// CHECK-PIC2-NOT: #define __pie__
//
// RUN: %lfort_cc1 -pie-level 1 -dM -E -o - %s \
...
// CHECK-PIE1: #define __pie__ 1
//
// RUN: %lfort_cc1 -pie-level 2 -dM -E -o - %s \
