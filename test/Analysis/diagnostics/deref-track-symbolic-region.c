// RUN: %lfort_cc1 -analyze -analyzer-checker=core -analyzer-output=text -verify %s
// RUN: %lfort_cc1 -analyze -analyzer-checker=core -analyzer-output=plist-multi-file %s -o - | FileCheck %s
