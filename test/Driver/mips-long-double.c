// RUN: %lfort_cc1 -triple mips64-unknown-freebsd -std=c11 -verify %s
// RUN: %lfort_cc1 -triple mips-unknown-freebsd -std=c11 -verify %s
// RUN: %lfort_cc1 -triple mips-unknown-linux-std=c11 -verify %s
