// RUN: %lfort_cc1 -fsyntax-only %s 2>&1 | FileCheck -strict-whitespace %s
// RUN: %lfort_cc1 -fsyntax-only -fdiagnostics-parseable-fixits %s 2>&1 | FileCheck -check-prefix=CHECK-MACHINE %s
