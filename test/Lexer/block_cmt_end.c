/*
  RUN: %lfort_cc1 -E -trigraphs %s | grep bar
  RUN: %lfort_cc1 -E -trigraphs %s | grep foo
  RUN: %lfort_cc1 -E -trigraphs %s | not grep qux
  RUN: %lfort_cc1 -E -trigraphs %s | not grep xyz
  RUN: %lfort_cc1 -fsyntax-only -trigraphs -verify %s  
*/
