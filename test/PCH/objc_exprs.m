...
// RUN: %lfort_cc1 -fblocks -include %S/objc_exprs.h -fsyntax-only -verify %s

// Test with pch.
// RUN: %lfort_cc1 -x objective-c-header -emit-pch -fblocks -o %t %S/objc_exprs.h
// RUN: %lfort_cc1 -fblocks -include-pch %t -fsyntax-only -verify %s 
