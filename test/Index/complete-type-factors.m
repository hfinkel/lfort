...
// RUN: c-index-test -code-completion-at=%s:16:11 -Xlfort -code-completion-patterns %s | FileCheck -check-prefix=CHECK-CC1 %s
...
// RUN: c-index-test -code-completion-at=%s:17:18 -Xlfort -code-completion-patterns %s | FileCheck -check-prefix=CHECK-CC2 %s
...
// RUN: c-index-test -code-completion-at=%s:18:10 -Xlfort -code-completion-patterns %s | FileCheck -check-prefix=CHECK-CC3 %s
...
// RUN: c-index-test -code-completion-at=%s:19:9 -Xlfort -code-completion-patterns %s | FileCheck -check-prefix=CHECK-CC4 %s
...
// RUN: c-index-test -code-completion-at=%s:21:9 -Xlfort -code-completion-patterns %s | FileCheck -check-prefix=CHECK-CC4 %s
// RUN: c-index-test -code-completion-at=%s:22:7 -Xlfort -code-completion-patterns %s | FileCheck -check-prefix=CHECK-CC6 %s
...
// RUN: c-index-test -code-completion-at=%s:31:13 -Xlfort -code-completion-patterns %s | FileCheck -check-prefix=CHECK-CC7 %s
// RUN: c-index-test -code-completion-at=%s:32:13 -Xlfort -code-completion-patterns %s | FileCheck -check-prefix=CHECK-CC7 %s
...
// RUN: c-index-test -code-completion-at=%s:31:26 -Xlfort -code-completion-patterns %s | FileCheck -check-prefix=CHECK-CC8 %s
// RUN: c-index-test -code-completion-at=%s:32:26 -Xlfort -code-completion-patterns %s | FileCheck -check-prefix=CHECK-CC8 %s
