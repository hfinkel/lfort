// RUN: rm -rf %t
// RUN: %lfort_cc1 -objcmt-migrate-literals -objcmt-migrate-subscripting -mt-migrate-directory %t %s -x objective-c -triple x86_64-apple-darwin11 
// RUN: c-arcmt-test -mt-migrate-directory %t | arcmt-test -verify-transformed-files %s.result
// RUN: %lfort_cc1 -triple x86_64-apple-darwin10 -fsyntax-only -x objective-c %s.result
