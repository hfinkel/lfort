// RUN: %lfort_cc1 -triple x86_64-unknown-unknown %s -Wno-null-conversion -fsyntax-only -verify
// RUN: %lfort_cc1 -triple i686-unknown-unknown %s -Wno-null-conversion -fsyntax-only -verify
