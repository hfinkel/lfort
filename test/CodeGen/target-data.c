// RUN: %lfort_cc1 -triple i686-unknown-unknown -emit-llvm -o %t %s
...
// RUN: %lfort_cc1 -triple i686-apple-darwin9 -emit-llvm -o %t %s
...
// RUN: %lfort_cc1 -triple x86_64-unknown-unknown -emit-llvm -o %t %s
